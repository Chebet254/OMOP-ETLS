...
SELECT
'CDM IDSR Generic Synthetic v3.1 Database' AS cdm_source_name,
'IDSR_GEN_SYN_v3_1' AS cdm_source_abbreviation,
'OHDSI' AS cdm_holder,
'WHO IDSR Data - Generic Synthetic V3.1' AS source_description,
'https://github.com/tathagatabhattacharjee/Generic-IDSR-COVID-19-data-to-OMOP-6.0-under-INSPIRE-Project' AS source_documentation_reference,
'https://github.com/tathagatabhattacharjee/Generic-IDSR-COVID-19-data-to-OMOP-6.0-under-INSPIRE-Project' AS cdm_etl_reference,
...
--CREATE RESULTS TABLES IN RESULTS SCHEMA
BEGIN;
CREATE TABLE IF NOT EXISTS magu_results.cohort
...
CREATE TABLE IF NOT EXISTS magu_results.cohort_censor_stats (cohort_definition_id int NOT NULL,
  lost_count BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS magu_results.cohort_inclusion (cohort_definition_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS magu_results.cohort_inclusion_result (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS magu_results.cohort_inclusion_stats (cohort_definition_id int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS magu_results.cohort_summary_stats (cohort_definition_id int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS magu_results.cohort_cache  (design_hash int NOT NULL,
	SUBJECT_ID bigint NOT NULL,
	cohort_start_date date NOT NULL,
	cohort_end_date date NOT NULL
);

CREATE TABLE IF NOT EXISTS magu_results.cohort_censor_stats_cache  (design_hash int NOT NULL,
  lost_count BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS magu_results.cohort_inclusion_result_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS magu_results.cohort_inclusion_stats_cache  (design_hash int NOT NULL,
  rule_sequence int NOT NULL,
  mode_id int NOT NULL,
  person_count bigint NOT NULL,
  gain_count bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS magu_results.cohort_summary_stats_cache  (design_hash int NOT NULL,
  mode_id int NOT NULL,
  base_count bigint NOT NULL,
  final_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS magu_results.feas_study_inclusion_stats (study_id int NOT NULL,
  rule_sequence int NOT NULL,
...
CREATE TABLE IF NOT EXISTS magu_results.feas_study_index_stats (study_id int NOT NULL,
  person_count bigint NOT NULL,
  match_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS magu_results.feas_study_result (study_id int NOT NULL,
  inclusion_rule_mask bigint NOT NULL,
  person_count bigint NOT NULL
);

CREATE TABLE IF NOT EXISTS magu_results.heracles_analysis
 (analysis_id int,
...
CREATE TABLE IF NOT EXISTS magu_results.HERACLES_HEEL_results 
...
BEGIN;
CREATE TABLE IF NOT EXISTS magu_results.heracles_results
 (cohort_definition_id int,
	analysis_id int,
...
--HINT BUCKET(analysis_id, 64)
BEGIN;
CREATE TABLE IF NOT EXISTS magu_results.heracles_results_dist
 (cohort_definition_id int,
	analysis_id int,
	stratum_1 varchar(255),
	stratum_2 varchar(255),
...
CREATE TABLE IF NOT EXISTS magu_results.heracles_periods
 (period_id int,
  period_order int,
...
CREATE TABLE IF NOT EXISTS magu_results.cohort_sample_element (cohort_sample_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS magu_results.ir_analysis_dist  (analysis_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS magu_results.ir_analysis_result (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS magu_results.ir_analysis_strata_stats (analysis_id int NOT NULL,
  target_id int NOT NULL,
  outcome_id int NOT NULL,
...
CREATE TABLE IF NOT EXISTS magu_results.ir_strata (analysis_id int NOT NULL,
  strata_sequence int NOT NULL,
  name varchar(255) NULL,
  description varchar(1000) NULL
);

CREATE TABLE IF NOT EXISTS magu_results.cc_results
...
CREATE TABLE IF NOT EXISTS magu_results.pathway_analysis_codes
...
CREATE TABLE IF NOT EXISTS magu_results.pathway_analysis_events
 (pathway_analysis_generation_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS magu_results.pathway_analysis_paths
 (pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
  step_1 BIGINT,
  step_2 BIGINT,
...
CREATE TABLE IF NOT EXISTS magu_results.pathway_analysis_stats
 (pathway_analysis_generation_id BIGINT NOT NULL,
  target_cohort_id INTEGER NOT NULL,
...
/*********************************************************************/
BEGIN;
CREATE TABLE IF NOT EXISTS magu_results.concept_hierarchy
 (concept_id             INT,
...
/***********************************************************/
TRUNCATE TABLE magu_results.concept_hierarchy;
...
TRUNCATE TABLE magu_results.heracles_analysis;

BEGIN;
insert into magu_results.heracles_analysis
