...
NEXTVAL('cdm_magu.location_id_seq') AS location_id,	
	...
	0 AS zip,
	NULL AS county,
	native_tables.residencies.hhold_id::VARCHAR AS location_source_value,
	4072112 AS country_concept_id,
	'TANZANIA' AS country_source_value,
	'-2.55' AS latitude, 
...
'https://github.com/Chebet254/Magu-HDSS-ALPHA-Data_to_OMOP-ETL-' AS source_documentation_reference,
'https://github.com/Chebet254/Magu-HDSS-ALPHA-Data_to_OMOP-ETL-' AS cdm_etl_reference,
